    ...
    render() {
        return(
            <div className='content'>
                ...
                <h3 id="personal_pro">Personal Projects</h3>
                ...
                <ul>
                    <li>A 3D web appplication that acts as an interactive resume. (this web app). Built with reactJS and three.JS. The source code can be found <a href="https://github.com/BigRed85/three-react-resume" target="_blank" rel="noopener noreferrer">here</a></li>
